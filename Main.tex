...
%   separate file.
\input{preamble/MainPackages}

% Sets up links within your document, for e.g. contents page entries
%  and references, and also PDF metadata.
% You should edit this!
\input{preamble/LinksAndMetadata}

% And then some settings in separate files.
\input{preamble/FloatSettings} % For things like figures and tables
...
\renewcommand{\footrulewidth}{0.4pt}
\fancyfoot[R]{\bfseries \thepage }
\include{Text_Files/Introduction}
\include{Text_Files/Chapter2}
\include{Text_Files/Chapter3}
\include{Text_Files/Chapter4}
\include{Text_Files/Conclusions}
% \include{Text_Files/Appendices}
