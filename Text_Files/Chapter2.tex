...
% \]
% and we can expand the action of the Hadamard circuit $V_{H}$ using Equation.~\ref{eq:hadamard_action}. This lets us write the exponential sum as
% \[
